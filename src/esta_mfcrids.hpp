...
namespace ESTA {
	namespace ManufacturerIDs {
		...
		std::map<uint16_t, std::string> Manufacturers = {
			...
			{0x07C2, "BOOQlight BV"},
			{0x07C, "SBS Lighting LLC"},
			{0x07C, "BK Lighting"},
			{0x07C8, "Sidus Link Ltd."},
			{0x07CC, "Griven S.r.l."},
			{0x07CF, "MH-Sound"},
			{0x07D, "Made By Mouse LTD"},
			...
			{0x08C, "Guangzhou Ever Famous Electronic Co.,Ltd"},
			{0x08C9, "LEDitgo Videowall Germany GmbH"},
			{0x08C, "Foshan City Xuandao Optoelectronics Equipment Co., Ltd"},
			...
			{0x08F, "Guang Dong LMJ Lighting Co., Ltd"},
			...
			{0x08F, "RPA Electronic Solutions Inc."},
			...
			{0x5007, "Alfalite"},
			{0x5007, "Prizm Lighting (part of American Lighting Inc.)"},
